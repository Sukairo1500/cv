...
redis:setex(bot_id..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:del(bot_id..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "⇠ هذا الامر يخص ( المطور,المالك,المدير ) بس  \n" end
redis:setex(bot_id..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_,300,true)
...
local AlRdod = redis:smembers(bot_id..':KlmatRRandom:'..msg.chat_id_) 
if #AlRdod == 0 then return "⇠ الردود العشوائيه محذوفه بالفعل " end
for k,v in pairs(AlRdod) do redis:del(bot_id..':ReplayRandom:'..msg.chat_id_..":"..v) redis:del(bot_id..':caption_replay:Random:'..msg.chat_id_..v) 
end
redis:del(bot_id..':KlmatRRandom:'..msg.chat_id_) 
...
local incrr = redis:scard(bot_id..':ReplayRandom:'..msg.chat_id_..":"..v) 
...
--====================== Reply Random Public =====================================
if redis:get(bot_id..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_) and redis:get(bot_id..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(bot_id..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(bot_id..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_)
redis:del(bot_id..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_)
sendMsg(msg.chat_id_,msg.id_,'⇠ تم اضافه رد متعدد عشوائي  \n\n⇠ تقدر ترسل (['..klma..']) لاضهار الردود العشوائيه . ')
redis:del(bot_id..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
return false
end

local CountRdod = redis:scard(bot_id..':ReplayRandom:'..klma) or 1
...
redis:sadd(bot_id..':KlmatRRandom:',klma) 
redis:sadd(bot_id..':ReplayRandom:'..klma,":Text:"..msg.text) 
...
redis:sadd(bot_id..':KlmatRRandom:',klma) 
redis:sadd(bot_id..':ReplayRandom:'..klma,":Photo:"..photo_id) 
...
redis:sadd(bot_id..':KlmatRRandom:',klma) 
redis:sadd(bot_id..':ReplayRandom:'..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_) 
...
redis:sadd(bot_id..':KlmatRRandom:',klma) 
redis:sadd(bot_id..':ReplayRandom:'..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_) 
...
redis:sadd(bot_id..':KlmatRRandom:',klma) 
redis:sadd(bot_id..':ReplayRandom:'..klma,":Video:"..msg.content_.video_.video_.persistent_id_) 
...
redis:sadd(bot_id..':KlmatRRandom:',klma) 
redis:sadd(bot_id..':ReplayRandom:'..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_) 
...
redis:sadd(bot_id..':KlmatRRandom:',klma) 
redis:sadd(bot_id..':ReplayRandom:'..klma,":Document:"..msg.content_.document_.document_.persistent_id_) 
...
redis:sadd(bot_id..':KlmatRRandom:',klma) 
redis:sadd(bot_id..':ReplayRandom:'..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_) 
...
if redis:get(bot_id..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_) and redis:get(bot_id..'replay1Random'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(bot_id..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(bot_id..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_)
redis:del(bot_id..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_)
sendMsg(msg.chat_id_,msg.id_,'⇠ تم اضافه رد متعدد عشوائي \n⇠ تقدر ترسل (['..klma..']) لاضهار الردود العشوائيه . ')
redis:del(bot_id..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
return false
end

local CountRdod = redis:scard(bot_id..':ReplayRandom:'..msg.chat_id_..":"..klma) or 1
local CountRdod2 = 10 - tonumber(CountRdod)
local CountRdod = 9 - tonumber(CountRdod)
if CountRdod2 == 0 then 
redis:del(bot_id..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(bot_id..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(bot_id..':ReplayRandom:'..msg.chat_id_..":"..klma,":Text:"..msg.text) 
return sendMsg(msg.chat_id_,msg.id_,'تم حطيت الرد باقي '..CountRdod..'\n تم ادراج الرد ارسل رد اخر او ارسل {تم}')
elseif msg.content_.ID == "MessagePhoto" then
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
...
redis:sadd(bot_id..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(bot_id..':ReplayRandom:'..msg.chat_id_..":"..klma,":Photo:"..photo_id) 
CaptionInsert(msg,photo_id,false)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم ادراج صور للرد باقي '..CountRdod..' \n⇠ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageVoice" then
redis:sadd(bot_id..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(bot_id..':ReplayRandom:'..msg.chat_id_..":"..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_) 
CaptionInsert(msg,msg.content_.voice_.voice_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم ادراج الفويس للرد باقي '..CountRdod..' \n⇠ ارسل رد اخر او ارسل {تم}')
elseif msg.content_.ID == "MessageAnimation" then
redis:sadd(bot_id..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(bot_id..':ReplayRandom:'..msg.chat_id_..":"..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_) 
CaptionInsert(msg,msg.content_.animation_.animation_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم ادراج المتحركه للرد باقي '..CountRdod..' \n⇠ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageVideo" then
redis:sadd(bot_id..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(bot_id..':ReplayRandom:'..msg.chat_id_..":"..klma,":Video:"..msg.content_.video_.video_.persistent_id_) 
CaptionInsert(msg,msg.content_.video_.video_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم ادراج الفيديو للرد باقي '..CountRdod..' \n⇠ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageAudio" then
redis:sadd(bot_id..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(bot_id..':ReplayRandom:'..msg.chat_id_..":"..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_) 
CaptionInsert(msg,msg.content_.audio_.audio_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم ادراج الصوت للرد باقي '..CountRdod..' \n⇠ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageDocument" then
redis:sadd(bot_id..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(bot_id..':ReplayRandom:'..msg.chat_id_..":"..klma,":Document:"..msg.content_.document_.document_.persistent_id_) 
CaptionInsert(msg,msg.content_.document_.document_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم ادراج الملف للرد باقي '..CountRdod..' \n⇠ ارسل رد اخر او ارسل {تم} .')  
elseif msg.content_.ID == "MessageSticker" then
redis:sadd(bot_id..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(bot_id..':ReplayRandom:'..msg.chat_id_..":"..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_) 
...
redis:hset(bot_id..'replay:'..msg.chat_id_,klma,msg.text)
...
elseif msg.content_.ID == "MessageDocument" then
redis:hset(bot_id..'replay_files:group:'..msg.chat_id_,klma,msg.content_.document_.document_.persistent_id_ )
redis:del(bot_id..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(bot_id..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(bot_id..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(bot_id..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.caption_ then redis:hset(bot_id..':caption_replay:',klma,msg.content_.caption_) end
if msg.text then
redis:del(bot_id..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_,"⇠ معليش غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر ")
end
redis:hset(bot_id..'replay:all',klma,msg.text)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\nتم اضافة الرد \n لكل المجموعات ')
elseif msg.content_.ID == "MessagePhoto" then 
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
...
redis:hset(bot_id..'replay_photo:group:',klma,photo_id)
redis:del(bot_id..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم اضافه صوره للرد العام \n⇠ تقدر ترسل (['..klma..']) عشان تشوف الرد ياحلو \n𓍦')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(bot_id..'replay_voice:group:',klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(bot_id..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم اضفت الفويس للرد العام \n⇠ تقدر ترسل (['..klma..']) عشان تشوف الرد ياحلو \n𓍦')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(bot_id..'replay_animation:group:',klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(bot_id..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم اضافه متحركه للرد العام \n⇠ تقدر ترسل (['..klma..']) عشان تشوف الرد ياحلو \n𓍦')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(bot_id..'replay_video:group:',klma,msg.content_.video_.video_.persistent_id_)
redis:del(bot_id..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم اضافه فيديو للرد العام \n⇠ تقدر ترسل (['..klma..']) عشان تشوف الرد ياحلو')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(bot_id..'replay_audio:group:',klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(bot_id..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم اضافه للصوت للرد العام \n⇠ تقدر ترسل (['..klma..']) عشان تشوف الرد ياحلو')
elseif msg.content_.ID == "MessageDocument" then
redis:hset(bot_id..'replay_files:group:',klma,msg.content_.document_.document_.persistent_id_ )
redis:del(bot_id..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⇠ تم اضافه ملف للرد العام \n⇠ تقدر ترسل (['..klma..']) عشان تشوف الرد ياحلو')  
elseif msg.content_.ID == "MessageSticker" then
redis:hset(bot_id..'replay_sticker:group:',klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(bot_id..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
send(msg.chat_id_, msg.id_, "\n⇽  معليش ما ما اقدر اطرد "..Get_Rank(msg.sender_user_id_,msg.chat_id_).." ")
return false
end
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=msg.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,"⇽  مو لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
return false  
end
...
send(msg.chat_id_, msg.id_,"⇽  معليش ما ما اقدر اطرد ادمنية المجموعه") 
return false  
end
...
if text == 'ايدي' or text == 'كشف' then
  ...
  send(msg.chat_id_, msg.id_,'• مافيه حساب بهاذا المعرف')
  end
  end
  tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Status, nil)
  return false
